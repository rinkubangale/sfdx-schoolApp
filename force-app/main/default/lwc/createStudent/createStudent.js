...
export default class CreateStudent extends LightningElement {
    ...
    GuardianLastName = '';
    PointOfContact = '';
    @track FirstNameLabel = 'First Name';
    @track LastNameLabel = 'Last Name';
    ...
    handleInputChange(event) {
        ...
        if (event.target.label == "Religion") {
            this.Religion = event.detail.value;
            console.log(this.Religion)
        }
        if (event.target.label == "Occupation") {
            this.Occupation = event.detail.value;
            console.log(this.Occupation)
            //console.log('helloooo===>>>')
        }
        if (event.target.label == "Father First Name") {
            this.FatherFirstName = event.detail.value;
            console.log(this.FatherFirstName + JSON.stringify(this.FatherFirstName))
        }
        if (event.target.label == "Father Last Name") {
            this.FatherLastName = event.detail.value;
            console.log(this.FatherLastName + JSON.stringify(this.FatherLastName))
        }
        if (event.target.label == "Mother First Name") {
            this.MotherFirstName = event.detail.value;
        }
        if (event.target.label == "Mother Last Name") {
            this.MotherLastName = event.detail.value;
        }
        if (event.target.label == "Guardian First Name") {
            this.GuardianFirstName = event.detail.value;
        }
        if (event.target.label == "Guardian Last Name") {
            this.GuardianLastName = event.detail.value;
        }
    ...
    saveChangeHandler(event) {
        ...
        console.log('helloooooo+++++++++', this.Year);
        ...
        fields[Religion.fieldApiName] = this.Religion;
        fields[Occupation.fieldApiName] = this.Occupation;
        ...
        fields['RecordTypeId'] = '0126D000002lC22QAE';

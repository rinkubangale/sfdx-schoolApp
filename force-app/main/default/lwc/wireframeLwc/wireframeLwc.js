...
export default class WireframeLwc extends LightningElement {
    ...
    @wire(getPicklistValues, { recordTypeId: '0126D000002lC21QAE', fieldApiName: CITY_FIELD })
    cityPicklist;
    @wire(getPicklistValues, { recordTypeId: '0126D000002lC21QAE', fieldApiName: COUNTRY_FIELD })
    countryPicklist;
    @wire(getPicklistValues, { recordTypeId: '0126D000002lC21QAE', fieldApiName: STATE_FIELD })
    statePicklist;

    @wire(getPicklistValues, { recordTypeId: '0126D000002lC21QAE', fieldApiName: SCHOOLTYPE_FIELD })
    schooltypePicklist;
    @wire(getPicklistValues, { recordTypeId: '0126D000002lC21QAE', fieldApiName: GRADEFROM_FIELD })
    gradefromPicklist;
    @wire(getPicklistValues, { recordTypeId: '0126D000002lC21QAE', fieldApiName: GRADETO_FIELD })
    gradetoPicklist;
    @wire(getPicklistValues, { recordTypeId: '0126D000002lC21QAE', fieldApiName: AFFILIATETOBOARD_FIELD })
    affiliatetoboardPicklist;
    @wire(getPicklistValues, { recordTypeId: '0126D000002lC21QAE', fieldApiName: LANGUAGE_FIELD })
    languagePicklist;
    @wire(getPicklistValues, { recordTypeId: '0126D000002lC21QAE', fieldApiName: MEDIUM_FIELD })
    mediumPicklist;
    @wire(getPicklistValues, { recordTypeId: '0126D000002lC21QAE', fieldApiName: PROMOTED_FIELD })
    promotedPicklist;
    @wire(getPicklistValues, { recordTypeId: '0126D000002lC21QAE', fieldApiName: SCHOOLFACILITIES_FIELD })
    schoolfacilitiesPicklist;
    @wire(getPicklistValues, { recordTypeId: '0126D000002lC21QAE', fieldApiName: BOARDTYPE_FIELD })
    boardtypePicklist;

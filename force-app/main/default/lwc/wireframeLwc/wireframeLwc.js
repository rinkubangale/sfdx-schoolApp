...
const fields = [
  ...
  GRADEFRM_FIELD,
  GRADET_FIELD,
  AFFILIATEBOARD_FIELD,
  LANGUAGEINSTRUCTION_FIELD,
  SCHOOLSTATUS_FIELD,
  SCHOOLESTABLISHMENT_FIELD,
  AFFILIATIONGRANTEDON_FIELD,
  REGISTERWITH_FIELD,
  TOTALSTUDENT_FIELD,
  BOARDTYPES_FIELD,
  MEDIUMS_FIELD,
...
export default class WireframeLwc extends LightningElement {
  ...
  fwtAccountDate({ data, error }) {
    if (data) {
      ...
      console.log(
        "---->>Acc",
        JSON.parse(JSON.stringify(this.accounts.fields.Name.value))
      );
      this.schoolname = this.accounts.fields.Name.value;
      console.log("---->>Acc---->", this.schoolname);

      this.affiliateIds = JSON.parse(
        JSON.stringify(this.accounts.fields.Affiliate_Id__c.value)
      );
      this.streets = JSON.parse(
        JSON.stringify(this.accounts.fields.Street__c.value)
      );
      this.states = JSON.parse(
        JSON.stringify(this.accounts.fields.State__c.value)
      );
      this.cities = JSON.parse(
        JSON.stringify(this.accounts.fields.City_Town__c.value)
      );
      this.postalcodes = JSON.parse(
        JSON.stringify(this.accounts.fields.PinCode__c.value)
      );
      this.countries = JSON.parse(
        JSON.stringify(this.accounts.fields.Country__c.value)
      );
      this.schooltypes = JSON.parse(
        JSON.stringify(this.accounts.fields.Shcool_Type__c.value)
      );
      this.gradefroms = JSON.parse(
        JSON.stringify(this.accounts.fields.Grade_From__c.value)
      );
      this.gradetos = JSON.parse(
        JSON.stringify(this.accounts.fields.Grade_To__c.value)
      );
      this.affiliateboards = JSON.parse(
        JSON.stringify(this.accounts.fields.Affiliate_to_Board__c.value)
      );
      this.languages = JSON.parse(
        JSON.stringify(this.accounts.fields.Language_of_Instruction__c.value)
      );
      this.statuss = JSON.parse(
        JSON.stringify(
          this.accounts.fields.Status_of_School_Affiliation__c.value
        )
      );
      this.schoolestablishments = JSON.parse(
        JSON.stringify(
          this.accounts.fields.Year_of_School_Establishment__c.value
        )
      );
      this.affiliationgranted = JSON.parse(
        JSON.stringify(
          this.accounts.fields.School_Affiliation_Granted_On__c.value
        )
      );
      this.registerwiths = JSON.parse(
        JSON.stringify(this.accounts.fields.School_Registered_With__c.value)
      );
      this.totalstudents = JSON.parse(
        JSON.stringify(this.accounts.fields.Total_Number_of_Students__c.value)
      );
      this.boardtypes = JSON.parse(
        JSON.stringify(this.accounts.fields.Board_Type__c.value)
      );
      this.mediums = JSON.parse(
        JSON.stringify(this.accounts.fields.Medium__c.value)
      );
      this.admissions = JSON.parse(
        JSON.stringify(this.accounts.fields.Admission_Open__c.value)
      );
      this.landnumbers = JSON.parse(
        JSON.stringify(this.accounts.fields.Landline_Number__c.value)
      );
      this.websites = JSON.parse(
        JSON.stringify(this.accounts.fields.Website.value)
      );
      this.promoteds = JSON.parse(
        JSON.stringify(this.accounts.fields.Promoted__c.value)
      );
      this.verifieds = JSON.parse(
        JSON.stringify(this.accounts.fields.Is_Verified__c.value)
      );
      this.descriptions = JSON.parse(
        JSON.stringify(this.accounts.fields.Description.value)
      );
      console.log("---->>Acc", this.accounts);
      if (
        this.accounts.fields.School_Facilities__c.value != null ||
        this.accounts.fields.School_Facilities__c.value != ""
      ) {
        this.accounts.fields.School_Facilities__c.value
          .split(";")
          .map((item) => {
  ...
  handleremove(event) {
    console.log(
      "---> event  ",
      JSON.stringify(event.target.name),
  ...
  @wire(getPicklistValues, {
    recordTypeId: "0126D000002lC21QAE",
  ...
  @wire(getPicklistValues, {
    recordTypeId: "0126D000002lC21QAE",
    fieldApiName: SCHOOLTYPE_FIELD
  })
  schooltypePicklist;

  @wire(getPicklistValues, {
    recordTypeId: "0126D000002lC21QAE",
    fieldApiName: GRADEFROM_FIELD
  })
  gradefromPicklist;

  @wire(getPicklistValues, {
    recordTypeId: "0126D000002lC21QAE",
    fieldApiName: GRADETO_FIELD
  })
  gradetoPicklist;

  @wire(getPicklistValues, {
    recordTypeId: "0126D000002lC21QAE",
    fieldApiName: AFFILIATETOBOARD_FIELD
  })
  ...
  @wire(getPicklistValues, {
    recordTypeId: "0126D000002lC21QAE",
    fieldApiName: MEDIUM_FIELD
  })
  mediumPicklist;

  @wire(getPicklistValues, {
    recordTypeId: "0126D000002lC21QAE",
    fieldApiName: PROMOTED_FIELD
  })
  promotedPicklist;

  @wire(getPicklistValues, {
    recordTypeId: "0126D000002lC21QAE",
    fieldApiName: SCHOOLFACILITIES_FIELD
  })
  schoolfacilitiesPicklist;

  @wire(getPicklistValues, {
    recordTypeId: "0126D000002lC21QAE",
    fieldApiName: BOARDTYPE_FIELD
  })
  boardtypePicklist;

  // connectedCallback() {
  //   console.log("lineNo 683 cc==>", this.boardtypePicklist.data.values);
  // }
  ...
  handleModalChange() {
    this.dispatchEvent(new CustomEvent("modalchange", { details: false }));
  }
  ...
  Updatedetails() {
    ...
    var acc = {
      ...
      State__c: this.province,
      City_Town__c: this.city,
      PinCode__c: this.postalcode,
      Affiliate_Id__c: this.affiliateId,
      Shcool_Type__c: this.schooltype,
      Grade_From__c: this.gradefrom,
      Grade_To__c: this.gradeto,
      Affiliate_to_Board__c: this.affiliatetoboard,
      Language_of_Instruction__c: this.language,
      Status_of_School_Affiliation__c: this.statusaffiliation,
      Year_of_School_Establishment__c: this.yse,
      School_Affiliation_Granted_On__c: this.sag,
      School_Registered_With__c: this.schoolregisteredwith,
      Total_Number_of_Students__c: this.noofstudents,
      Board_Type__c: this.boardtype,
      Medium__c: this.medium,
      Admission_Open__c: this.admissionopen,
      Landline_Number__c: this.landlinenumber,
      Website: this.website,
      Promoted__c: this.promoted,
      Is_Verified__c: this.isverified,
      Description: this.describeschool,
      School_Facilities__c: this.allvalues.join(";")
    };

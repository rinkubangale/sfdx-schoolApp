...
// const retiredFields=[,Assigned__c,ActiveField];



export default class AssetDetailsPage extends LightningElement {
    activeSections = ['Asset Details'];
    @api EmpId;
    @api assetttId;
    @api recordId;
    @api Inventory__c;
    ...
    isInputValid() {
        console.log('2');
        let isValid = true;
        console.log('isValidInvoked-------',isValid)
        let inputFields = this.template.querySelectorAll('.validate');
        console.log('this.INPUTFIELDS----',inputFields);
        inputFields.forEach(inputField => {
            console.log('inputField---',inputField)
            if(!inputField.checkValidity()) {
                console.log('inputcheckvalidity---');
                inputField.reportValidity();
                console.log('inputreportValidity---');
                isValid = false;
                console.log('isValid----',isValid)
            }
            // this.Inventory__c[inputField.name] = inputField.value;
        });
        return isValid;
    }
